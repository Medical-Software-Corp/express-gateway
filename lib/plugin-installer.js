...
import YAWN from 'yawn-yaml/cjs/index.js';
...
class PluginInstaller {
  ...
  async getExistingPluginOptions () {
    const config = this.config || (await import('./config/index.js')).default;
  ...
  async _generateSystemConfigData (name, pluginOptions) {
    const config = this.config || (await import('./config/index.js')).default;
  ...
  async _generateGatewayConfigData (policyNames) {
    const config = this.config || (await import('./config/index.js')).default;
    const isJSON =
