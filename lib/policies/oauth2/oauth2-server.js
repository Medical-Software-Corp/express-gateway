...
export const authorization = [
  ...
  (request, response) => {
    ...
    response.render(path.join(import.meta.dirname, 'views/dialog'), { transactionId: request.oauth2.transactionID, user: request.user, client: request.oauth2.client, scope: request.oauth2.req.scope });
  }
];
