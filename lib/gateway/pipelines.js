...
import EgContextBase from './context.js';
import ActionParams from './actionParams.js';
import * as conditionsModule from '../conditions/index.js';
const { conditions } = conditionsModule;
import conditionDefinitions from '../conditions/predefined.js';

export async function bootstrap ({ app, config }) {
